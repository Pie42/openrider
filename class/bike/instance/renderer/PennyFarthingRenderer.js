...
export default class PennyFarthingRenderer {
    /**
     *
    ...
    static render(ctx, bike, opacityFactor) {
        ...
        let frontWheelRadius = (bike.frontWheel.size - wheelLineWidth / 2) * bike.track.zoomFactor;
        ...
        ctx.arc(frontWheel.x, frontWheel.y, frontWheelRadius, 0, 2 * Math.PI, true);
        ctx.stroke();
        // ---------- wheels axes
        ...
        // front wheel
        ctx.moveTo(frontWheel.x + frontWheelRadius, frontWheel.y);
        ctx.arc(frontWheel.x, frontWheel.y, frontWheelRadius * 0.4, 0, 2 * Math.PI, true);
        ctx.fill();
        ctx.globalAlpha = opacityFactor;
        // ---------- bike parts
